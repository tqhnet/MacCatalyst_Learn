...
- (dispatch_block_t)cm_changeHeighrBlock {
        
    return objc_getAssociatedObject(self, @selector(cm_changeHeighrBlock));
    
}

- (void)setCm_changeHeighrBlock:(dispatch_block_t)cm_changeHeighrBlock {
    
     objc_setAssociatedObject(self, @selector(cm_changeHeighrBlock), cm_changeHeighrBlock, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)updateHight {
    ...
    if (self.cm_changeHeighrBlock) {
        self.cm_changeHeighrBlock();
    }
